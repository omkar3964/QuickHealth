        ...
        <div className=' flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div>
            <p className='text-gray-500 font-medium mt-4'>
              Appointment fee: <span className='text-gray-600'><img className='size-2.5  inline-block ' src={assets.rupees} alt="rs" />{/*currencySymbol*/} {docInfo.fees} </span></p>
          </div>
